...
import image from "../../../assets/Untitled-3.png";
        ...
        <footer aria-label="Site Footer" className=" lg:grid lg:grid-cols-5 bg-gray-100">
            ...
            <div className="relative  h-56 m-5 lg:col-span-2">
                <img
                    src={image}
                    alt=""
                    className="absolute inset-0 object-cover w-96"
                />
            </div>
            ...
            <div className="px-4 pt-5 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    ...
                    <div className="grid grid-cols-1 pt-5 gap-4 sm:grid-cols-2">
                        <div>
                            <p className="font-medium text-md text-gray-900">Seller/buyer Services</p>
                        ...
                        <div>
                            <p className="font-medium font-bold text-lg text-sky-500">Oto Deals</p>
                ...
                <div className="pt-12 mt-12 border-t border-gray-100">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <p className="mt-8 text-xs text-gray-500 sm:mt-0">
                            &copy; 2022. Oto-Deals. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
