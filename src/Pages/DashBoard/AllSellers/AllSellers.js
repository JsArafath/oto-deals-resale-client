...
=======
        " https://oto-resale-server-main.vercel.app/users/allsellers"
...
=======
    fetch(` https://oto-resale-server-main.vercel.app/seller/${id}`, {
>>>>>>> cf8fad9 (first commit)
      method: "DELETE",
      headers: {
...
=======
    fetch(` https://oto-resale-server-main.vercel.app/seller/verify/${id}`, {
>>>>>>> cf8fad9 (first commit)
      method: "PUT",
    })
      .then((res) => res.json())
