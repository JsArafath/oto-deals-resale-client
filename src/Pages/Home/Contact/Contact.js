            ...
            <form className="flex flex-col border  space-y-6 text-gray-700 p-5 ng-untouched ng-pristine ng-valid" ref={form} onSubmit={sendEmail}>
              <label className="block">
                ...
                <input
                  ...
                  className="block w-full rounded-md shadow-sm bg-white border input-md mt-2"
                  required
                />
              </label>
              <label className="block">
              ...
              <label className="block">
                ...
                <textarea
                  rows="3"
                  className="block w-full rounded-md bg-white border shadow-sm input-md mt-2"
                ></textarea>
              </label>
              <button
                type="submit"
                className="uppercase self-center w-full px-8 py-3 font-semibold rounded bg-sky-500 text-white  hover:bg-secondary"
              >
                Submit
              </button>
            </form>
