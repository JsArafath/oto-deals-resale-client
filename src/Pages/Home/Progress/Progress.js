...
const Progress = () => {
	...
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div className="flex p-9 space-x-4 rounded-lg md:space-x-6 dark:bg-cyan-700 dark:text-gray-100">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-blue-100">
