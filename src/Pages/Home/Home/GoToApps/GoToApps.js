...
const GoToApps = () => {
	...
	<div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
		<div className="flex flex-col justify-center lg:text-left">
			<p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-blue-800">Buy or Sell products in online, no matter where you are.</p>
			<h1 className="py-2 text-3xl font-medium leading-tight title-font">
            Don't have Oto-Deals yet?
            </h1>
		</div>
		<div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
			<button className="inline-flex items-center px-6 py-3 rounded-lg dark:bg-sky-500 dark:text-gray-100">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-current w-7 h-7 dark:text-gray-100">
			...
			<button className="inline-flex items-center px-5 py-3 rounded-lg dark:bg-sky-500 dark:text-gray-100">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="fill-current w-7 h-7 dark:text-gray-100">
